...
import { formatDateFull, getYearMonth } from '../../../shared/utils/date';
import { useAddTransaction, useUpdateTransaction, useRecentNames } from '../hooks/useTransactions';
...
export const TransactionAddScreen: React.FC<Props> = ({ navigation, route }) => {
  ...
  const categories: CategoryDef[] = type === 'expense' ? EXPENSE_CATEGORIES : INCOME_CATEGORIES;
  ...
  return (
    ...
    >
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>{isEdit ? '거래 수정' : '거래 추가'}</Text>
